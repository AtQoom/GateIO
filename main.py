...
GRID_GAP_PCT = Decimal(os.environ.get("GRID_GAP_PCT", "0.16")) / Decimal("100")  # 0.16%
TP_GAP_PCT = Decimal(os.environ.get("TP_GAP_PCT", "0.16")) / Decimal("100")      # 0.16%
HEDGE_RATIO = Decimal(os.environ.get("HEDGE_RATIO", "0.2"))                      # 0.2배
THRESHOLD_RATIO = Decimal(os.environ.get("THRESHOLD_RATIO", "1.0"))              # 1배
LEVERAGE_MIN = Decimal(os.environ.get("LEVERAGE_MIN", "0.21"))                   # 최소 0.21
LEVERAGE_MAX = Decimal(os.environ.get("LEVERAGE_MAX", "0.40"))                   # 최대 0.40
