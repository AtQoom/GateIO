...
from gate_api import ApiClient, Configuration, FuturesApi, FuturesOrder, exceptions as gate_api_exceptions
...
SYMBOL_MAPPING = {
    "BTCUSDT": "BTC_USDT", "BTCUSDTPERP": "BTC_USDT", "BTC_USDT":"BTC_USDT",
    "ETHUSDT": "ETH_USDT", "ETHUSDTPERP": "ETH_USDT", "ETH_USDT":"ETH_USDT",
    "SOLUSDT": "SOL_USDT", "SOLUSDTPERP": "SOL_USDT", "SOL_USDT":"SOL_USDT",
    "ADAUSDT": "ADA_USDT", "ADAUSDTPERP": "ADA_USDT", "ADA_USDT":"ADA_USDT",
    "SUIUSDT": "SUI_USDT", "SUIUSDTPERP": "SUI_USDT", "SUI_USDT":"SUI_USDT",
    "LINKUSDT": "LINK_USDT", "LINKUSDTPERP": "LINK_USDT", "LINK_USDT":"LINK_USDT",
    "PEPEUSDT": "PEPE_USDT", "PEPEUSDTPERP": "PEPE_USDT", "PEPE_USDT":"PEPE_USDT",
    "XRPUSDT": "XRP_USDT", "XRPUSDTPERP": "XRP_USDT", "XRP_USDT":"XRP_USDT",
    "DOGEUSDT": "DOGE_USDT", "DOGEUSDTPERP": "DOGE_USDT", "DOGE_USDT":"DOGE_USDT",
    "ONDOUSDT": "ONDO_USDT", "ONDOUSDTPERP": "ONDO_USDT", "ONDO_USDT":"ONDO_USDT",
}
SYMBOL_CONFIG = {
    ...
    with position_lock:
        ...
        if is_sl_rescue_condition(symbol):
            ...
            if success:
                ...
                log_debug("SL-Rescue", f"{symbol} qty={qty} side={side}")
...
if __name__ == "__main__":
    log_debug("서버시작", "Gate.io 자동매매 서버 (예전코드 기반 + 개선 적용)")
